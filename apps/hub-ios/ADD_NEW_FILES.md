...
2. `HubApp.swift` reference still exists in Xcode but the file has been deleted

## Quick Fix: Remove Stale HubApp.swift Reference
...
4. **Find and select `HubApp.swift`** in the list
...
3. Navigate to `apps/hub-ios/HubApp/Core/Models/`
...
2. Select **"Add Files to 'Psychosis'..."**
3. Navigate to `apps/hub-ios/HubApp/Features/RemoteDesktop/`
...
2. Select **"Add Files to 'Psychosis'..."**
3. Navigate to `apps/hub-ios/HubApp/Resources/`
