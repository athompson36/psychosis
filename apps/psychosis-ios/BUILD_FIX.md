...
2. **`apps/psychosis-ios/PsychosisApp/`** folder - Files manually added to project
...
1. **Delete manually added files** from project:
   - In Xcode Project Navigator, find files under `PsychosisApp/` folder
   - Select them and press Delete → "Remove Reference"
   
2. **Copy content** from `apps/psychosis-ios/PsychosisApp/` files to `Psychosis/Psychosis/` files:
   - Copy code from `apps/psychosis-ios/PsychosisApp/App/PsychosisApp.swift` to `Psychosis/Psychosis/PsychosisApp.swift`
   - Copy code from `apps/psychosis-ios/PsychosisApp/App/ContentView.swift` to `Psychosis/Psychosis/ContentView.swift`
...
4. **Keep** only manually added files from `apps/psychosis-ios/PsychosisApp/`

### Option 3: Use One Location Only

**Recommended**: Move all files to `Psychosis/` folder and remove `apps/psychosis-ios/PsychosisApp/` references.
...
- ⚠️ `apps/psychosis-ios/PsychosisApp/App/PsychosisApp.swift` (manually added - duplicate)
- ⚠️ `apps/psychosis-ios/PsychosisApp/App/ContentView.swift` (manually added - duplicate)
- ❌ `apps/psychosis-ios/PsychosisApp/App/PsychosisApp.swift` (old name - should be deleted)
